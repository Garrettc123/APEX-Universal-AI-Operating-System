...
from src.superintelligence import GoalPlanner, Knowledge, ReasoningEngine, SelfImprovementEngine, Superintelligence
...
class TestKnowledge:
    ...
    def test_knowledge_creation(self):
        knowledge = Knowledge(domain="test_domain", facts=["fact1", "fact2"], confidence=0.9, timestamp=1.0)
...
class TestSuperintelligence:
    ...
    def test_autonomous_decision(self):
        si = Superintelligence()
        context = {"options": ["option_a", "option_b", "option_c"], "constraints": ["time", "budget"]}
